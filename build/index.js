...
var import_colyseus_core = require("@bizsim-game-studios/colyseus-core");
...
import_colyseus_core.Room.prototype.getAvailableData = function() {
  return {
...
import_colyseus_core.Room.prototype.getRoomListData = async function() {
...
import_colyseus_core.Room.prototype.getInspectData = async function() {
...
import_colyseus_core.Room.prototype._forceClientDisconnect = async function(sessionId) {
...
import_colyseus_core.Room.prototype._sendMessageToClient = async function(sessionId, type, data) {
  for (let i = 0; i < this.clients.length; i++) {
    if (this.clients[i].sessionId === sessionId) {
...
function monitor(opts = {}) {
  ...
  router.use(import_express2.default.static(frontendDirectory));
