  ...
  "node_modules/node-gyp-build-optional-packages/node-gyp-build.js"(exports2, module2) {
    ...
    load.resolve = load.path = function(dir) {
      ...
      if (!prebuildsOnly) {
        ...
        var debug3 = getFirst(path3.join(dir, "build/Debug"), matchBuild);
...
// src-backend/index.ts
var frontendDirectory = import_path2.default.resolve(__dirname, "..", "build", "static");
